...
module.exports = {
    ...
    READ_MESSAGES: convertToBool(process.env.READ_MESSAGES) || truee,
    ...
    SESSION: (process.env.SESSION || process.env.SESSION_ID || '').trim() || 'Raganork~a2db28b8c36d128aa6ba62d5b9b1699f:717a626244544e516778773d',
    ...
    NOT_ALLOWED: process.env.ALLOWED || '91,24,212',
    ...
    SUDO: process.env.SUDO || "254718835933",
